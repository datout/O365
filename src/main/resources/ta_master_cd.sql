...
insert into ta_master_cd(key_ty,cd,decode,start_dt,end_dt,create_dt,last_update_id,last_update_dt) values ('NO_INVITE_REG_ENABLE','Y','公开注册(无邀请码)开关：Y启用/N关闭',sysdate,null,sysdate,'o365',sysdate);
insert into ta_master_cd(key_ty,cd,decode,start_dt,end_dt,create_dt,last_update_id,last_update_dt) values ('NO_INVITE_REG_LIMIT','0','公开注册(无邀请码)可注册数量上限(整数)',sysdate,null,sysdate,'o365',sysdate);
insert into ta_master_cd(key_ty,cd,decode,start_dt,end_dt,create_dt,last_update_id,last_update_dt) values ('NO_INVITE_REG_USED','0','公开注册(无邀请码)已使用数量（系统自动累加）',sysdate,null,sysdate,'o365',sysdate);
insert into ta_master_cd(key_ty,cd,decode,start_dt,end_dt,create_dt,last_update_id,last_update_dt) values ('NO_INVITE_REG_DOMAIN','','公开注册(无邀请码)默认域名(不含@)，例如 x86.cc.cd',sysdate,null,sysdate,'o365',sysdate);
insert into ta_master_cd(key_ty,cd,decode,start_dt,end_dt,create_dt,last_update_id,last_update_dt) values ('NO_INVITE_REG_LICENSE','','公开注册(无邀请码)默认订阅skuId(GUID)，固定分配',sysdate,null,sysdate,'o365',sysdate);
