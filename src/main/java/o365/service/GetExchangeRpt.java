...
import o365.dao.TaAppRptRepo;
import o365.domain.TaAppRpt;
	...
	public boolean execute(int seqNo) {
		...
		if(opt.isPresent()) {
			...
			if(!"".equals(accessToken)) {
				...
				try(BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("exchange_details.csv"), "GB2312"))) {
